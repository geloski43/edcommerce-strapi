...
export interface ApiCurrencySettingCurrencySetting
  extends Struct.CollectionTypeSchema {
  collectionName: 'currency_settings';
  info: {
    displayName: 'Currency-Setting';
    pluralName: 'currency-settings';
    singularName: 'currency-setting';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::currency-setting.currency-setting'
    > &
      Schema.Attribute.Private;
    precision: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<2>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    order_items: Schema.Attribute.Relation<
      ...
      'api::order-item.order-item'
    >;
    orderAmount: Schema.Attribute.Decimal;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    isDigital: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::product.product'
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    owned: Schema.Attribute.Relation<'oneToMany', 'api::product.product'>;
    password: Schema.Attribute.Password &
      Schema.Attribute.Private &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 6;
    ...
    publishedAt: Schema.Attribute.DateTime;
    purchased: Schema.Attribute.Relation<'oneToMany', 'api::product.product'>;
    resetPasswordToken: Schema.Attribute.String & Schema.Attribute.Private;
    role: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.role'
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::currency-setting.currency-setting': ApiCurrencySettingCurrencySetting;
